...
visualdetect <- readr::read_csv("data/COSW/COSW_VisualDetect_Tidy.csv", locale = locale(encoding = "latin1"))
effort <- readr::read_csv("data/COSW/COSW_Effort_Tidy.csv", locale = locale(encoding = "latin1"))
operations <- readr::read_csv("data/COSW/COSW_Operations_Tidy.csv", locale = locale(encoding = "latin1"))
...
\[AVG DISTANCE AT FIRST DETECTION IS DIFFERENT FROM WHAT IS REPORTED FOR HUMPBACK WHALE AND UNIDENTIFIED WHALE\]
